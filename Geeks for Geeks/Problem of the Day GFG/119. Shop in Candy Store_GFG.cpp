...
// candies[] = {3 2 1 4}
// Output: 3 7
// Explanation: As according to the offer if you buy one candy you can take at most two 
// more for free. So in the first case, you buy the candy which costs 1 and takes candies worth 3 and 4 for free, also you buy candy worth 2 as well. So min cost : 1+2 =3.
...
public:
   vector<int> candyStore(int candies[], int N, int K){
       ...
       for(int i=0,j=N-1;i<=mx && j>=mi;i++,j--){
           mincost+=candies[i];
           maxcost+=candies[j];
           mx -=K;
           mi +=K;
