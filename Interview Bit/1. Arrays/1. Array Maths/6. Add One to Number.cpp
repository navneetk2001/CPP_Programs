...
// Input 1: [1, 2, 3]
// Output 1: [1, 2, 4]
// Explanation 1: Given vector is [1, 2, 3]. The returned vector should be [1, 2, 4] as 123 + 1 = 124.
...
// Case 1:
// The number of digits after adding 1 remains the same. This is the easy case. Simulate the mathematical process of adding one maintaining carry from the digit.

// Case 2:
// The number of digits increases by 1 when adding. This causes some complication as you would have to shift all digits by 1 to make space for the new digit in the most significant position.
