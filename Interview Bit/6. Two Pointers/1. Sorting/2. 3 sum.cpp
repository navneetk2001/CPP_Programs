...
class Solution {
    public:
        int threeSumClosest(vector<int> &num, int target) {
            ...
            int bestSum = 1000000000, sum = 0;        // Fix the smallest number in the three integers
            
            for (int i = 0; i < num.size() - 2; i++) {
                int ptr1 = i + 1, ptr2 = num.size() - 1;         // Now num[i] is the smallest number in the three integers in the solution
                while (ptr1 < ptr2) {
